...
class ServiceClient {
  ...
  async getAllKelas(authToken) {
    return this.callService("academic", "/api/academic/kelas", "GET", {
      headers: { Authorization: authToken },
    });
  }

  async getAllSiswa(authToken) {
    return this.callService("academic", "/api/academic/siswa", "GET", {
      headers: { Authorization: authToken },
    });
  }

  async getAllGuru(authToken) {
    return this.callService("academic", "/api/academic/guru", "GET", {
      headers: { Authorization: authToken },
    });
  }

  async getAllMapel(authToken) {
    return this.callService("academic", "/api/academic/mapel", "GET", {
      headers: { Authorization: authToken },
    });
  }
