...
-- Tambahan penting untuk schema lama
ALTER TABLE nilai_siswa
ADD COLUMN IF NOT EXISTS guru_id UUID;

-- Optional: pastikan kolom lain juga ada kalau schema pernah berubah
ALTER TABLE nilai_siswa
ADD COLUMN IF NOT EXISTS kelas_id INTEGER;

ALTER TABLE nilai_siswa
ADD COLUMN IF NOT EXISTS tahun_ajar VARCHAR(20);

ALTER TABLE nilai_siswa
ADD COLUMN IF NOT EXISTS nilai_tugas NUMERIC(5,2) DEFAULT 0;

ALTER TABLE nilai_siswa
ADD COLUMN IF NOT EXISTS nilai_kuis NUMERIC(5,2) DEFAULT 0;

ALTER TABLE nilai_siswa
ADD COLUMN IF NOT EXISTS nilai_uts NUMERIC(5,2) DEFAULT 0;

ALTER TABLE nilai_siswa
ADD COLUMN IF NOT EXISTS nilai_uas NUMERIC(5,2) DEFAULT 0;

ALTER TABLE nilai_siswa
ADD COLUMN IF NOT EXISTS nilai_praktik NUMERIC(5,2) DEFAULT 0;
