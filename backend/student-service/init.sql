...
END $$;
=======
CREATE TABLE IF NOT EXISTS student_grades (id SERIAL PRIMARY KEY, student_id VARCHAR(100) NOT NULL, student_name VARCHAR(150), nis VARCHAR(50), mapel VARCHAR(100), kelas VARCHAR(50), tahun_ajar VARCHAR(20), tugas NUMERIC(5,2), kuis NUMERIC(5,2), uts NUMERIC(5,2), uas NUMERIC(5,2), praktik NUMERIC(5,2), nilai_akhir NUMERIC(5,2));
>>>>>>> Stashed changes
