...
export const academicApi = {
  ...
  getArsipSuratPreviewUrl: (id) => `${axiosInstance.defaults.baseURL || 'http://localhost:8001'}/api/academic/arsip-surat/${id}/preview`,
...
<<<<<<< Updated upstream
  ...
  getRekapNilaiWali: (params) => axiosInstance.get('/api/academic/wali/rekap-nilai', { params }),
  getRekapAbsensiWali: (params) => axiosInstance.get('/api/academic/wali/rekap-absensi', { params }),

  // ── ABSENSI SISWA ──────────────────────────────────────────────────────
  getAbsensiSiswa: (params) => axiosInstance.get('/api/academic/absensi-siswa', { params }),
