...
import RekapNilaiGuruPage from "./pages/guru-mapel/RekapNilaiPage";
...
import RekapNilaiWaliKelas from "./pages/wali-kelas/RekapNilaiPage";
...
import SuratPanggilanPage from "./pages/wali-kelas/SuratPanggilanPage";
...
import RekapNilaiFinalPage from "./pages/kepala-sekolah/RekapNilaiFinalPage";
      ...
      <div className="flex min-h-screen bg-gray-50">
            ...
            <div className="mt-4 space-y-1">
              ...
              {hasRole("guru-mapel") && (
                ...
                >
                  ...
                  <NavLink to="/guru-mapel/rekap-nilai" className={subNavClass}>
                    Rekap Nilai
                  </NavLink>
              ...
              {hasRole("wali-kelas") && (
                ...
                >
                  ...
                  <NavLink to="/wali/surat-panggilan" className={subNavClass}>
                    Surat Panggilan
                  </NavLink>
                </NavDropdown>
              )}
        ...
        <main className="flex-1 p-8 overflow-y-auto">
          <Routes>
            ...
            <Route
              path="/guru-mapel/rekap-nilai"
              element={<RekapNilaiGuruPage />}
            />
            ...
            />
            <Route path="/wali/rekap-nilai" element={<RekapNilaiWaliKelas />} />
            ...
            <Route
              path="/wali/surat-panggilan"
              element={<SuratPanggilanPage />}
            />
