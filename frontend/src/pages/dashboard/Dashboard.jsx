    ...
    <div className="p-6 max-w-6xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 flex items-start gap-4">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-sm text-gray-500 mt-1">
              Anda login sebagai {roleDesc} pada sistem informasi SMK N 1
              Sigumpar.
            </p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 flex flex-col items-center justify-center">
          ...
          <p className="text-4xl font-bold font-mono text-gray-800 tracking-wider">
            {formatTime(time)}
          </p>
        ...
        {totalPages > 1 && (
          <div className="px-6 py-4 border-t border-gray-100 flex items-center justify-between bg-white">
            <span className="text-xs text-gray-500">
              ...
              {Math.min(indexOfLast, pengumumanList.length)} dari{" "}
