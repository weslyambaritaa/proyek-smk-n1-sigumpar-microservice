          ...
          <div className="p-6">
            <div className="flex flex-col md:flex-row gap-6">
              <div className="flex-1 space-y-4">
                ...
                <div>
                  ...
                  <textarea value={ringkasan} onChange={(e) => setRingkasan(e.target.value)}
                    placeholder="Ringkasan hasil pertemuan..." rows={5}
              ...
              <div className="w-full md:w-56 flex flex-col gap-3">
                <label className="block text-xs font-bold text-gray-500 uppercase tracking-widest">Foto / Dokumen</label>
                <div
                ...
                >
                  {fotoPreview ? (
                    <img src={fotoPreview} alt="Preview foto"
                      ...
                      onClick={() => handlePreviewFoto(fotoPreview, "Preview Lampiran Parenting")}
                ...
                <input ref={fileInputRef} type="file" accept="image/*,.pdf" className="hidden" onChange={handleFotoChange} />
                {fotoPreview && (
                  <div className="flex gap-2">
                    <button type="button" onClick={() => handlePreviewFoto(fotoPreview, "Preview Lampiran Parenting")}
                ...
                <p className="text-xs text-gray-400 text-center leading-relaxed">JPG, PNG, PDF<br />Maks 10MB</p>
              </div>
            </div>
          </div>
        </form>
                    ...
                    <td className="px-5 py-3">
                      {h.foto_url ? (
                        <img
                          ...
                          alt="Foto Parenting"
                          onClick={() => handlePreviewFoto(h.foto_url, `Lampiran — ${h.agenda}`)}
