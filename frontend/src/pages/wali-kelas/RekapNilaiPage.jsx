          ...
          <>
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-5">
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
                ...
                <div>
                  <label className="block text-xs font-bold text-gray-500 uppercase mb-1.5">Mata Pelajaran</label>
              ...
              <>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  {[
                    ...
                    { label: `Lulus (≥70)`, value: `${lulus}/${filtered.length}`, icon: "✅" },
                  ].map(s => (
                  ...
                  <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between px-6 py-4 border-b border-gray-100 gap-3">
                    <div>
                      <h2 className="font-bold text-gray-800">
                        Rekap Nilai{namaKelas && <span className="text-gray-400 font-normal"> — {namaKelas}</span>}
                      </h2>
                      <p className="text-xs text-gray-400">{namaMapel || "Semua Mapel"} · {tahun} · {filtered.length} siswa</p>
                    </div>
            ...
            {!sudahCari && (
              <div className="bg-white rounded-2xl border border-gray-100 shadow-sm py-16 text-center text-gray-400">
                <p className="text-4xl mb-2">📊</p>
                <p className="font-medium text-gray-600">Pilih Kelas dan Tahun Ajar</p>
        ...
        {tab === "riwayat" && (
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            <div className="px-6 py-4 border-b border-gray-100">
              <h2 className="font-bold text-gray-800 mb-3">Riwayat Nilai Siswa</h2>
