            ...
            <div className="flex-1 overflow-y-auto px-6 py-6 space-y-6">
              <div className="p-4 bg-red-50 border border-red-200 rounded-lg">
                ...
                <p className="text-sm text-red-700">
                  Dengan menghapus, data kelas ini tidak lagi dapat diakses. Daftar kelas yang akan dihapus:
                </p>
              ...
              <div>
                <label className="block text-sm font-semibold text-gray-700 mb-2">
                  Ketik ulang <span className="font-bold text-black border-b-2 border-red-500">{kelasToDelete?.nama_kelas}</span> untuk konfirmasi
                </label>
                <input
                  type="text"
